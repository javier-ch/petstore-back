...
public class Usuario {
    ...
    private String regeneraClaveInstante;
	...
	public String getRegeneraClaveInstante() {
		return regeneraClaveInstante;
	}

	public void setRegeneraClaveInstante(String regeneraClaveInstante) {
		this.regeneraClaveInstante = regeneraClaveInstante;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((regeneraClaveInstante == null) ? 0 : regeneraClaveInstante.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (instanteUltimoCambioClave != other.instanteUltimoCambioClave)
			return false;
		if (regeneraClaveInstante == null) {
			if (other.regeneraClaveInstante != null)
				return false;
		} else if (!regeneraClaveInstante.equals(other.regeneraClaveInstante))
			return false;
